...
Holistix Forge is licensed under the **GNU Affero General Public License v3.0** (AGPL-3.0).
...
- If you host Holistix Forge as a service and modify it, you must provide the source code to your users
...
1. **Personal Use**
   ...
   - Use Holistix Forge for your personal projects
   - Modify it for your own use
   - No need to share your modifications if you don't distribute

2. **Internal Business Use**

   - Use Holistix Forge internally in your organization
...
1. **SaaS/Hosted Service**
   ...
   - Host Holistix Forge as a service for your customers
...
2. **Commercial Product**
   ...
   - Integrate Holistix Forge into a commercial product
...
1. **Use Proprietary License**
   ...
   - You cannot relicense Holistix Forge or derivative works under a proprietary license
...
When you contribute to Holistix Forge:
...
Holistix Forge includes third-party dependencies with their own licenses. Most dependencies use permissive licenses (MIT, Apache 2.0, BSD) that are compatible with AGPL-3.0.
...
### Q: Can I use Holistix Forge for my commercial business?
...
### Q: Can I host Holistix Forge for my clients?
...
### Q: Can I create a proprietary SaaS based on Holistix Forge?

**A:** No. Any service based on Holistix Forge must be licensed under AGPL-3.0, and you must provide source code access to your users. You can charge for your service, but you cannot make it proprietary.
...
### Q: Can I integrate Holistix Forge with proprietary software?
...
**A:** If users interact with your modified version of Holistix Forge over a network (web, API, etc.), that counts as providing a service. The network use clause applies.
...
### Q: Can I sell support or services for Holistix Forge?
...
If you're distributing Holistix Forge or running it as a service with modifications:
