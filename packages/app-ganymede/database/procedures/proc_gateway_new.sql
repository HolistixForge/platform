CREATE OR REPLACE PROCEDURE public.proc_gateway_new(
    IN in_hostname character varying(256),
...
BEGIN
    ...
    INSERT INTO public.gateways (gateway_id, hostname, version, ready, container_name, http_port, vpn_port)
    VALUES (gateway_id, in_hostname, in_version, FALSE, in_container_name, in_http_port, in_vpn_port);
