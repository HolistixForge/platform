...
import {
  ...
  TWhiteboardMenuEntries,
  TWhiteboardMenuEntry,
} from './lib/whiteboard-menu';
import {
  TLayerProvider,
...
export type { TWhiteboardMenuEntries, TWhiteboardMenuEntry };
...
export type TUIElements = {
  ...
  getMenuEntries: TWhiteboardMenuEntries;
...
export const moduleFrontend: TModule<TRequired, TWhiteboardFrontendExports> = {
  name: 'whiteboard',
  version: '0.0.1',
  ...
  load: ({ depsExports, moduleExports }) => {
    ...
    exports.registerMenuEntries(whiteboardMenuEntries);
