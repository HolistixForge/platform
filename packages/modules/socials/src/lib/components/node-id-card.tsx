...
export const IDCard: React.FC<IDCardProps> = ({ user, color }) => {
  return (
...
export const NodeIdCard = ({ node }: { node: TGraphNode }) => {
  ...
  return <IDCard user={user} color={'#ffa500'} />;
};

//

const dropShadowColor = 'rgba(0, 0, 0, 0.5)';
